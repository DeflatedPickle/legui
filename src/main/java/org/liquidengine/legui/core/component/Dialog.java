...
import org.liquidengine.legui.core.component.misc.listener.dialog.DialogCloseEventListener;
 ...
 * created {@link Layer} which forbid underlying layers to receive mouse click and keyboard events.
 * <p>
 */
public class Dialog extends Widget {
    ...
    public void show(Frame frame) {
        ...
        if (this.frame != null) {
            ...
            if (dialogLayer == null) {
                dialogLayer = new Layer();
                dialogLayer.setEventPassable(false);
                dialogLayer.setEventReceivable(true);
                dialogLayer.getStyle().getBackground().setColor(0, 0, 0, 0.2f);
            }
